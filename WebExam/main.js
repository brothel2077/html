...
const apiKey = "6e85c48b-13bc-4a5f-b7ab-de4c55fbe62e";
let allRoutes;
...
function createTooltipTh(data) {                                               //Тултип для th
...
function createTooltip(data) {                                               //Тултип для td
...
function searchGuidesForRoute(event) {                                     //Нажатие на "Выбрать" в таблице маршрутов
...
function createRoute(data) {                     //Создание маршрута
    ...
    let row = document.createElement("tr");
    let th = createTooltipTh(data.name);               //Создание name
    th.setAttribute("scope", row);
    let numOfChars = 0;
    let name = "";
    ...
    //let desc = document.createElement("td");             //Создание description
    numOfChars = 0;
    let descWords = "";
    ...
    //let mainObj = document.createElement("td");          //Создание main objects
    numOfChars = 0;
    let mainObjects = "";
    ...
    let btnTd = document.createElement("td");              //Создание кнопок списка
    let btn = document.createElement("button");
    btn.classList.add("btn");
    btn.classList.add("btn-light");
...
async function downloadData() {                                 //Загрузка данных с api
